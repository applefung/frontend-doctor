...
class VideoConferenceOneToOne
 extends React.Component {
  constructor(props) {
    ...
    this.serviceIP = 'http://192.168.8.4:3000'
  ...
  componentDidMount = () => {this.setState({room:this.props.navigation.getParam('id')}) }
...
export default VideoConferenceOneToOne;
